...
if [[ "$arch" != "x86_64" ]] || [[ $FORCE_SWAP -eq 1 ]]; then
    ...
    sed -E -i 's|d5bc8eba7eb2322de7789ab751c4f9afee7c4b74ea7308f15cdafaf870beb288|c38c754a2e31ae9466b5ea740d1741700f7bc4160ce6573cecd9389bf996ad12|g' $devfiles
    sed -E -i 's|plugin-java11-rhel8|plugin-java11-openj9-rhel8|g' $devfiles
    sed -E -i 's|2036cbb70aae5f5d507657bd4b820e340ee0bacf3d4b520d80dbd21aad85e13a|fc5e110243a8e30d23705897a1766de20ec637db4442d419ba05ace3b874c27f|g' $devfiles
